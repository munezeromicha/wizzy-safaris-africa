        ...
        <div className="relative z-20 container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl w-full mb-12">
            ...
            <div className="bg-white/90 p-6 rounded-lg shadow-lg">
              <h2 className="text-2xl font-semibold mb-4">
                Africa Wizzy Safaris
              </h2>
              <p className="text-lg mb-4">
                Discover the wonders of Africa with Africa Wizzy Safaris. We
                offer unforgettable experiences, from wildlife adventures to
                cultural explorations, ensuring a unique and enriching journey.
              </p>
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="bg-gray-100 p-4 rounded-lg">
                  <h3 className="font-semibold mb-2">Wildlife Adventures</h3>
                  <ul className="list-disc list-inside text-sm w-100 whitespace-nowrap">
                    <li>Accessible Gorilla Trekking</li>
                    <li>Accessible Wildlife Safaris</li>
                    <li>Wheelchair accessible safaris </li>
                    <li>Family friendly safaris package </li>
                    <li>Budget friendly packages</li>
                    <li>Accessible canoeing</li>
                    <li>Deaf Safaris</li>
                    <li>Hiking & trekking adventures </li>
                    <li>Senior friendly tours</li>
                    <li>culture and historical tours</li>
                  </ul>
                </div>
                <div className="bg-gray-100 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full mb-12">
            <div className="bg-white/90 p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-700">
                Embark on thrilling wildlife safaris with expert guides,
                witnessing Africa's majestic animals in their natural habitat.
              </p>
            </div>
            <div className="bg-white/90 p-6 rounded-lg shadow-lg text-center">
              <h3 className="text-xl font-semibold mb-3">Cultural Immersion</h3>
              <p className="text-gray-700">
                Connect with local communities, learn about traditions, and
                experience authentic African hospitality.
              </p>
            </div>
            <div className="bg-white/90 p-6 rounded-lg shadow-lg text-center">
              ...
              <p className="text-gray-700">
                From hiking through scenic landscapes to participating in
                conservation efforts, experience the best of African adventures.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#8A5624] opacity-90 p-8 rounded-lg max-w-2xl w-full text-center mx-auto">
            ...
            <p className="text-lg mb-4 text-white">
              Let our experienced team help you create the perfect African
              safari experience.
            </p>
